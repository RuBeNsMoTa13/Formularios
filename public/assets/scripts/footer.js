  ...
  footer.innerHTML = `
    <div class="container">
      ...
      <div class="footer-info">
        ...
        <br>
          <a href="#"><img src="/assets/images/linkedin-icon.png" alt="LinkedIn" class="social-links"  /></a>
          <a href="#"><img src="/assets/images/instagram-icon.png" alt="Instagram" class="social-links"  /></a>
        </div>
      </div>
    </div>
  `;
